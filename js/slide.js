var bgRotateAngle = 65; // Rotation angle of background slides
...
var currentSlide = 1; // The slide user is currently viewing
var oldCurrentSlide = currentSlide; // The previous slide user viewed
...
function displayGallery() {
    ...
    $('#gallery div').each(function () {
        var div = $(this);
        // Resize each slide if the window height has changed
